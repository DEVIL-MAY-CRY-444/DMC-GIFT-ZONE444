...
╚██████╗██║  ██║██║  ██║╚██████╗██║  ██╗    ██║     ██████╔╝    
 ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝    ╚═╝     ╚═════╝                                                                
                       {u}▪︎{k}▪︎{h}▪︎{sir} CRACK BY-SYAH X FORCE{x}{u}▪︎{k}▪︎{h}▪︎{x}''')                                                                         
...
def menu(my_name,my_id):
	...
	cetak(panel(f"[bold white]SYAH-XD,IQBAL ,Rapi SAPIRNA , Fanz XD, leo-xd -And lain lain",width=90,title=f"[bold green]Thanks To",padding=(0,5),style=f"bold white"))
